...
| Key | Action |
| --- | --- |
| Mouse | Rotate: angle around the projected pivot. Scale: signed factor from the invoke mouse radial. Flatten: same radial; invoke is 1 (on the plane), 0 at the pivot |
